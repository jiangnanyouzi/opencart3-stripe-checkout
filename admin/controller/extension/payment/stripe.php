...
class ControllerExtensionPaymentStripe extends Controller {
    ...
    public function index() {
        ...
        if (isset($this->request->post['payment_stripe_test_endpoint_key'])) {
            $data['payment_stripe_test_endpoint_key'] = $this->request->post['payment_stripe_test_endpoint_key'];
        } else if($this->config->has('payment_stripe_test_endpoint_key')){
            $data['payment_stripe_test_endpoint_key'] = $this->config->get('payment_stripe_test_endpoint_key');
        } else {
            $data['payment_stripe_test_endpoint_key'] = '';
        }
        ...
        if (isset($this->request->post['payment_stripe_live_endpoint_key'])) {
            $data['payment_stripe_live_endpoint_key'] = $this->request->post['payment_stripe_live_endpoint_key'];
        } else if($this->config->has('payment_stripe_live_endpoint_key')){
            $data['payment_stripe_live_endpoint_key'] = $this->config->get('payment_stripe_live_endpoint_key');
        } else {
            $data['payment_stripe_live_endpoint_key'] = '';
        }
        ...
        if (isset($this->request->post['payment_stripe_order_pending_status_id'])) {
            $data['payment_stripe_order_pending_status_id'] = $this->request->post['payment_stripe_order_pending_status_id'];
        } else if($this->config->has('payment_stripe_order_pending_status_id')){
            $data['payment_stripe_order_pending_status_id'] = $this->config->get('payment_stripe_order_pending_status_id');
        } else {
            $data['payment_stripe_order_pending_status_id'] = '';
        }
        ...
        if (isset($this->error['test_endpoint_key'])) {
            $data['error_test_endpoint_key'] = $this->error['test_endpoint_key'];
        } else {
            $data['error_test_endpoint_key'] = '';
        }
        ...
        if (isset($this->error['live_endpoint_key'])) {
            $data['error_live_endpoint_key'] = $this->error['live_endpoint_key'];
        } else {
            $data['error_live_endpoint_key'] = '';
        }
    ...
    protected function validate() {
        ...
        if(isset($this->request->post['payment_stripe_environment'])){
            ...
            if($this->request->post['payment_stripe_environment'] == 'test'){
                ...
                if(!isset($this->request->post['payment_stripe_test_endpoint_key']) || trim($this->request->post['payment_stripe_test_endpoint_key']) == ''){
                    $this->error['test_endpoint_key'] = $this->language->get('error_test_endpoint_key');
                }
                ...
                if(!isset($this->request->post['payment_stripe_live_endpoint_key']) || trim($this->request->post['payment_stripe_live_endpoint_key']) == ''){
                    $this->error['live_endpoint_key'] = $this->language->get('error_live_endpoint_key');
                }
